// src/layouts/ProviderSidebarLayout.jsx
import { useEffect, useState } from "react";
import { Outlet, Link, useLocation, useNavigate } from "react-router-dom";
import { Menu, X, LayoutDashboard, BookOpenCheck, LogOut } from "lucide-react";
import Navbar from "../../components/Navbar";
import { useDispatch } from "react-redux";
import { clearUser } from "../../redux/slice/authSlice";

const providerNav = [
  { name: "Services", href: "/provider/dashboard", icon: LayoutDashboard },
  { name: "Bookings", href: "/provider/bookings", icon: BookOpenCheck },
];
      ...
      >
        <div>
          <div className="flex items-center justify-between p-4 border-b">
            <h2 className="text-xl font-bold text-blue-600">Provider Panel</h2>
        ...
        <div className="p-4 border-t">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <button onClick={logout} className="text-xs text-red-600 hover:underline flex items-center gap-1 mt-1">
